...
CAPTION:
(Instagram投稿用の本文。1〜2文ごとに必ず改行を入れ、文章がずっと1行につながらないようにすること。目安は3〜5行、1行あたり20〜40文字程度の短い文で区切る。その後に空行を挟んでハッシュタグを8〜12個。ハッシュタグの大量羅列は逆効果になりやすいため個数を絞り、集客に効果的な地域名+グルメ系、ジャンル系、汎用の飲食系、店名などを厳選してバランスよく)
